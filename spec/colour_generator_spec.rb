 ...
 describe MastermindSname::GameColours do
  ...
  describe "#get_colours" do
    ...
    it 'returns ["r","y","g","b"]' do
      expect(MastermindSname::GameColours.set_colours(level)).to eq (["r","y","g","b"])
    end

    it 'returns ["r","y","g","b","o"]' do
      expect(MastermindSname::GameColours.set_colours(level_i)).to eq (["r","y","g","b","o"])
    end

    it 'returns ["r","y","g","b","o","v"]' do
      expect(MastermindSname::GameColours.set_colours(level_a)).to eq (["r","y","g","b","o","v"])
    end
